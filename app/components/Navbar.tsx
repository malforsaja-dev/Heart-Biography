    ...
    <div>
      ...
      >
        ...
        <nav className="flex flex-col mt-20 space-y-20">
          <Link className="text-blue-600 hover:text-blue-400 flex items-center button-3d" href="/lpwelle">
            <span>📈</span>
            {isHovered && <span className="ml-2">LpWelle</span>}
          </Link>
          <Link className="text-blue-600 hover:text-blue-400 flex items-center button-3d" href="/seiten">
            <span>📝</span>
